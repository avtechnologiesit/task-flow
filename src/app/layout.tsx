...
export const metadata: Metadata = {
  title: 'Taskflow - Premium personal project management',
  description: 'A calm, focused space for managing your projects. Smart views, kanban, calendar, recurring tasks.',
}
